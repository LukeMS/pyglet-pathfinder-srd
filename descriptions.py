...
DATA = {
    ...
    "races": {
        ...
        "duergar": (
            ...
            style('par') +
            """Given little choice, the desperate dwarves agreed. The fell god imbued the duergar with an innate mastery of magic, but also turned the dwarves' skin ashen gray and caused most of the males' hair (except for eyebrows and beards) to fall out as a reminder of the bargain made: {italic True} their gray faces - or duergar in the Dwarven tongue - would set them apart from those cowards who fled the crucible that forged the true members of the dwarven race{italic False}.""" +
            style('par') +
        ...
        "strix": (
            ...
            style('t3', "Relations: ") + style('regular') +
            """The strix of Devil's Perch are a paranoid lot, but those who leave their homeland to pursue a life of adventure grow more open-minded toward other races. Regardless, no strix ever truly shakes her distrust of humans. That motley race, strix believe, has simply committed too many atrocities against the winged people to ever be viewed as trusted friends. Some strix adventurers flat-out refuse to ally with humans. Others may grudgingly accept a human, but only after that human makes a sincere gesture of peace and goodwill. Oftentimes, saving a strix's life is the only way to earn her trust. Strix have few qualms about other non-human races, though they are standoffish with all non-strix. Any non-human that shows respect for and interest in the strix culture can eventually befriend them. The process might be slow, but the reward can be a fierce and loyal ally.""" +
        ...
        "vishkanyas": (
            ...
            ("\n\n" *2) +
            "{italic True}* >{italic False}   based on unofficial internet-lore."
            +"\n\n"),
    ...
    "stats": {
        ...
        'strenght':
            ...
            "Strength measures your character's muscle and physical power. This ability is especially important for " + (
                style('blue', 'fighters') + ", " +
                style('blue', 'barbarians') + ", " +
                style('blue', 'paladins') + ", " +
                style('blue', 'rangers') + " and " +
                style('blue', 'monks')
            ) +
...
if __name__ == '__main__':
    with open('descriptions_new.json', 'w') as f:
        json.dump(DATA, f, indent=4)
    with open('disclaimer.json', 'w') as f:
        json.dump(DISCLAIMER, f, indent=4)
